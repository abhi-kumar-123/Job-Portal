        ...
        <div>
          ...
          <div className='relative'>
            ...
            <button
              ...
              className='absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 hover:text-gray-500'
            >
        ...
        <div>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            >
              ...
              <div className='text-xs text-gray-500'>Looking for oppourtunites</div>
            </button>
            ...
            >
              ...
              <div className='font-medium'>Emloyer</div>
