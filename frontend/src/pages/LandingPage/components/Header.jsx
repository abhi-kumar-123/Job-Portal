        ...
        <div className='container mx-auto px-4'>
            <div className='flex items-center justify-between h-16'>
                ...
                <nav className='hidden md:flex items-center space-x-8'>
                    ...
                    <a className='text-gray-600 hover:text-gray-900 transition-colors font-medium ' onClick={() => navigate('/find-jobs')}>
                        Find Jobs
                    </a>
                    <a className='text-gray-600 hover:text-gray-900 transition-colors font-medium' onClick={() => {
                        navigate(
                        ...
                        <>
                            ...
                            <a
                                ...
                                className='bg-gradient-to-r from-blue-600 to-purple-600 text-white
                                 px-6 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-sm hover:shadow-md'
                            >
                                Sign Up
                            </a>
                        </>
