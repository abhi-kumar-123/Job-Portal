      ...
      <div className='container mx-auto px-4 relative z-10'>
        <div className='text-center mb-16 '>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Whether you're looking for your next oppourtunity or the perfect candidate,we have the tools and features to make it happen.
          </p>
        </div>
          ...
          <div>
            ...
            <div className='space-y-8'>
              {employerFeatures.map((feature, index) => (
                <div className='group flex items-center space-x-4 rounded-2xl hover:bg-purple-50 transition-all duration-300 cursor-pointer' key={index}>
