              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                ...
                <div className='space-y-6'>
                  ...
                  <div className='flex items-center space-x-4'>
                    ...
                    <img src={profileData.avatar} alt="Avatar" className='w-20 h-20 rounded-full object-cover border-b border-blue-500' />
                    <div >
                ...
                <div className='space-y-6'>
                  ...
                  <div className='flex items-center space-x-4'>
                    <img src={profileData.companyLogo} alt="companyLogo" className='w-20 h-20 rounded-full object-cover border-b border-blue-500' />
                    <div>
                      <h3 className='text-lg font-semibold text-gray-800'>
