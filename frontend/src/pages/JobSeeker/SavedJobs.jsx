          ...
          <div className="bg-white p-6 rounded-lg">
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              {savedJobsList.length === 0 ? (
                <div className="text-center py-16 lg:py-20 bg-white/20 backdrop-blur-xl rounded-2xl border border-white/20 ">
