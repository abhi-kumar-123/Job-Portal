          ...
          <div className="bg-white p-6 rounded-lg">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {jobDetails?.applicationStatus ? (
                    ...
                    <button className="bg-gradient-to-br from-blue-50 to-blue-50 text-sm text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform  hover:-translate-y-0.5" onClick={applyToJob}>
                      Apply Now
                    </button>
                  )}
                </div>
            ...
            <div className="px-0 pb-8 space-y-8">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-bold text-gray-900">
                          {jobDetails.salaryMin}-{jobDetails
                            .salaryMax}
                          <span className="text-lg text-gray-600 font-normal ml-1">per year</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2 text-sm text-emerald-700 bg-emerald-100 px-3 py-1 rounded-xl">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 border border-gray-700 rounded-xl p-6">
