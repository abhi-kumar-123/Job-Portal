...
const JobCard = ({
    ...
    return <div className='bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:shadow-gray-200 transition-all duration-300 group relative cursor-pointer overflow-hidden'
        onClick={onClick}
    >
            ...
            {!saved && (
                <>
                    {job?.applicationStatus ? (
                        ...
                        !hideApply && (
                            <button
                                className='bg-gradient-to-r from-blue-50 to-blue-50 text-sm text-blue-700 hover:text-white px-6 p-2.5 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5'
                                onClick={(e) => {
                                    e.stopPropagation();
                                    onApply();
                                }}
