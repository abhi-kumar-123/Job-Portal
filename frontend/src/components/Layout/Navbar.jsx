...
const Navbar = () => {
    ...
    return <header className='fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-700 '>
                ...
                <div className='flex items-center space-x-3'>
                    ...
                    {isAuthenticated ?
                        (
                            ...
                            <>
                                <a href='/login' className='text-gray-600 hover:text-gray-900 transition-colors font-medium px-4 py-2 rounded-lg hover:text-gray-50' >
                                    Login
                                </a>
