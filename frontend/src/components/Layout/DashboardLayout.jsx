...
const DashboardLayout = ({ activeMenu, children }) => {
    ...
    return <div className='flex h-screen bg-gray-50'>
        ...
        <div className={`flex-1 flex flex-col transition-all duration-300 ${isMobile ? 'ml-0' : sidebarCollapsed ? 'ml-16' : 'ml-64'
            ...
            {/* Top Header */}
            <header className='bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between sticky px-6 top-0 z-30'>
